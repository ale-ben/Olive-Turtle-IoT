 ...
 * @brief  Get the sensor data by polling (use 3.3V main controller for Fermion
 * version)
 * @details  Configure the sensor power mode and parameters (for compensating
 * the calibrated temperature and relative humidity in gas measurement)
...
#include <DFRobot_ENS160.h>
 ...
 // #define I2C_COMMUNICATION // I2C communication. Comment out this line of code if
                          // you want to use SPI communication.

#ifdef I2C_COMMUNICATION
/**
 *   For Fermion version, the default I2C address is 0x53, connect SDO pin to
 * GND and I2C address will be 0x52
 */
DFRobot_ENS160_I2C ENS160(&Wire, /*I2CAddr*/ 0x53);
#else
/**
 * Set up digital pin according to the on-board pin connected with SPI
 * chip-select pin csPin Available Pins. For example: ESP32&ESP8266(D3), m0(6)
 */
uint8_t csPin = 10;
